...
const CATEGORIES_DATA = [
  { id: 'genres', name: 'Жанри', tags: ['Екшн', 'Комедія', 'Драма', 'Романтика', 'Фентезі', 'Психологія', 'Жахи', 'Пригоди', 'Спорт', 'Навчальна література', 'Програмування', 'Наукова література', 'Довідник'] },
  { id: 'formats', name: 'Формат', tags: ['Манґа', 'Манхва', 'Книга'] },
